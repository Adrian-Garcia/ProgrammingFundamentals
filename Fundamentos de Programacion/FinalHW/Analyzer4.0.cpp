/*
Analyzer.cpp
This application analyze a .txt document. By receving the name of the .txt document and then, analyze
data acording on the option that the user give. The options are
